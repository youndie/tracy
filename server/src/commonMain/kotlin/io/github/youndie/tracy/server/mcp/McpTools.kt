...
import io.github.youndie.tracy.server.query.UnknownEntityKey
...
public class ToolFacade(
    ...
    public suspend fun listServices(): List<io.github.youndie.tracy.server.query.ServiceSummary> = logs.listServices()
    ...
    public suspend fun topTemplates(
        ...
        limit: Int = 30,
    ): io.github.youndie.tracy.server.query.TemplateStatsResult =
